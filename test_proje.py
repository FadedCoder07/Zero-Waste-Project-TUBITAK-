...
while True:
    ...
    model = cv2.dnn.readNetFromDarknet("C:/Users/CAN/Projeler/GitHub/yolov_4_TUBITAK/yolov4.cfg", "C:/Users/CAN/Projeler/GitHub/yolov_4_TUBITAK/yolov4_last.weights")
    
    layers = model.getLayerNames()
    output_layer_indices = model.getUnconnectedOutLayers()
    output_layer = [layers[layer - 1] for layer in output_layer_indices]
    
    model.setInput(frame_blob) # Burada düzeltme yapıldı
